...
export default function GroupClient({ groupId }: { groupId: string }) {
  ...
  return (
    <div className="min-h-screen px-10 lg:px-14 py-8">
      ...
      {/* Leave/Dissolve Group Confirmation Modal */}
      {showLeaveModal && (
        <div 
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{background: "rgba(239, 68, 68, 0.15)"}}>
                <SignOut size={32} weight="duotone" style={{color: "#EF4444"}} />
              </div>
              <div>
                <h3 className="text-xl font-bold mb-2" style={{color: "#FFFFFF"}}>
                  {group?.userRole.isOwner ? "Rasformirati grupu?" : "Napustiti grupu?"}
                </h3>
                <p className="text-sm" style={{color: "#FFFFFF", opacity: 0.7}}>
                  {group?.userRole.isOwner 
                    ? "Grupa će biti trajno obrisana. Svi članovi će biti uklonjeni, ali će transakcije ostati sačuvane."
                    : "Napustiće te grupu. Tvoje transakcije će ostati sačuvane."}
                </p>
              </div>
              <div className="flex gap-3 w-full mt-2">
                ...
                >
                  {group?.userRole.isOwner ? "Rasformirati" : "Napusti"}
                </button>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2" style={{color: "#FFFFFF"}}>Uspešno</h3>
                <p className="text-sm" style={{color: "#FFFFFF", opacity: 0.7}}>{modalMessage}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2" style={{color: "#FFFFFF"}}>Greška</h3>
                <p className="text-sm" style={{color: "#FFFFFF", opacity: 0.7}}>{modalMessage}</p>
              </div>
              <button
                onClick={() => setShowErrorModal(false)}
