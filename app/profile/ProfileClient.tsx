...
export default function ProfileClient({ user }: { user: UserType }) {
  ...
  const handleLeaveGroup = async (groupId: string) => {
    if (!confirm("Da li ste sigurni da želite da napustite ovu grupu?")) return
  ...
  const handleDeleteGroup = async (groupId: string) => {
    if (!confirm("Da li ste sigurni da želite da raspustite ovu grupu? Ova akcija je nepovratna.")) return
