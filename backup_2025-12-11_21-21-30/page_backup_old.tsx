...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{background: '#0F0F1A'}}>
      ...
      {/* Hero Section */}
      <main className="relative z-10 px-6 py-16 lg:py-28 animate-fadeIn" style={{animation: 'fadeIn 0.4s ease-out'}}>
        <style jsx>{`
          @keyframes fadeIn {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-3">
                <button
                  onClick={() => router.push('/register')}
                  className="group px-8 py-3.5 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center gap-3"
                  style={{
                    background: 'linear-gradient(135deg, #9F70FF, #4C8BEA)',
                    color: '#FFFFFF',
                    fontFamily: '"Inter", sans-serif',
                ...
                <button
                  onClick={() => router.push('/login')}
                  className="px-8 py-3.5 rounded-xl font-semibold transition-all duration-200 hover:scale-[1.02]"
                  style={{
                    background: '#1C1A2E',
                    border: '1px solid #2E2B44',
                    color: '#FFFFFF',
            ...
            <div className="relative" style={{animation: 'fadeUp 0.4s ease-out 0.2s both'}}>
              <div className="relative space-y-3">
                {/* Balance Card */}
                <div 
                  className="rounded-3xl p-5 shadow-[0_0_35px_-10px_rgba(0,0,0,0.45)] transition-all duration-300" 
                ...
                >
                  <div className="flex items-start justify-between mb-2.5">
                    ...
                    <div className="w-11 h-11 rounded-xl flex items-center justify-center" style={{background: 'rgba(127, 223, 255, 0.12)'}}>
                      <Wallet size={22} weight="duotone" style={{color: '#7FDFFF'}} />
                    </div>
                  </div>
                  ...
                  {[
                    ...
                    >
                      <div className="flex flex-col items-center justify-center text-center">
                        <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-2" style={{background: `${item.color}15`}}>
      ...
      <section className="relative z-10 px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <div className="rounded-3xl p-10 lg:p-12 shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)]" style={{
            background: 'linear-gradient(145deg, #1E1B2A, #171421)',
            border: '1px solid rgba(255,255,255,0.06)'
          }}>
            <h2 className="text-3xl lg:text-4xl font-bold mb-3" style={{color: '#FFFFFF', fontFamily: '"Inter", sans-serif', fontWeight: 700}}>
              Spremni da počnete?
            </h2>
            <p className="text-lg mb-7" style={{color: 'rgba(255, 255, 255, 0.65)', fontFamily: '"Inter", sans-serif', fontWeight: 400}}>
              Pridružite se i preuzmite kontrolu nad svojim finansijama danas
            </p>
            <button
              onClick={() => router.push('/register')}
              className="group px-10 py-3.5 rounded-xl font-semibold transition-all duration-200 hover:scale-[1.02] inline-flex items-center gap-3"
              style={{
                background: 'linear-gradient(135deg, #9F70FF, #4C8BEA)',
                color: '#FFFFFF',
                fontFamily: '"Inter", sans-serif',
