      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <Filter className="w-5 h-5" style={{ color: '#9F70FF' }} />
            </div>
            <div>
              <h2 className="text-lg font-bold" style={{ color: '#FFFFFF' }}>Filteri</h2>
              {activeFiltersCount > 0 && (
                <span className="text-xs" style={{ color: '#9F70FF' }}>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6" style={{ 
          scrollbarWidth: 'thin',
          scrollbarColor: 'rgba(159, 112, 255, 0.3) transparent'
        }}>
          {/* Date Range */}
          <div>
            <label className="flex items-center gap-2 text-sm font-semibold mb-3" style={{ color: '#E8D9FF' }}>
              <Calendar className="w-4 h-4" style={{ color: '#9F70FF' }} />
              Datum
            </label>
            <div className="space-y-1.5">
              {[
                ...
                <label
                  ...
                  style={{
                    background: filters.dateRange === option.value ? 'rgba(159, 112, 255, 0.15)' : 'rgba(255, 255, 255, 0.03)',
                    border: filters.dateRange === option.value ? '1px solid rgba(159, 112, 255, 0.3)' : '1px solid rgba(255, 255, 255, 0.06)',
                  }}
                >
                  <input
                    type="radio"
          ...
          {categories.length > 0 && (
            <div>
              <label className="flex items-center gap-2 text-sm font-semibold mb-3" style={{ color: '#E8D9FF' }}>
                <Tag className="w-4 h-4" style={{ color: '#9F70FF' }} />
                Kategorije
              </label>
              <div className="space-y-1.5">
                {categories.map(category => (
                  <label
                    ...
                    className="flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-all hover:scale-[1.02]"
                    style={{
                      background: filters.categories.includes(category.id) ? 'rgba(159, 112, 255, 0.15)' : 'rgba(255, 255, 255, 0.03)',
                      border: filters.categories.includes(category.id) ? '1px solid rgba(159, 112, 255, 0.3)' : '1px solid rgba(255, 255, 255, 0.06)',
                    }}
                  >
                    <input
                      type="checkbox"
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-semibold mb-3" style={{ color: '#E8D9FF' }}>
              <DollarSign className="w-4 h-4" style={{ color: '#9F70FF' }} />
              Iznos (RSD)
            </label>
          ...
          {members.length > 0 && (
            <div>
              <label className="flex items-center gap-2 text-sm font-semibold mb-3" style={{ color: '#E8D9FF' }}>
                <User className="w-4 h-4" style={{ color: '#9F70FF' }} />
                Korisnici
              </label>
              <div className="space-y-1.5">
                {members.map(member => (
                  <label
                    ...
                    className="flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-all hover:scale-[1.02]"
                    style={{
                      background: filters.users.includes(member.id) ? 'rgba(159, 112, 255, 0.15)' : 'rgba(255, 255, 255, 0.03)',
                      border: filters.users.includes(member.id) ? '1px solid rgba(159, 112, 255, 0.3)' : '1px solid rgba(255, 255, 255, 0.06)',
                    }}
                  >
                    <input
                      type="checkbox"
        ...
        >
          ...
          <button
            ...
            className="flex-1 px-4 py-3 text-sm font-semibold rounded-xl transition-all hover:scale-105"
            style={{
              background: 'linear-gradient(135deg, #9F70FF, #7B5CFF)',
              color: '#FFFFFF',
